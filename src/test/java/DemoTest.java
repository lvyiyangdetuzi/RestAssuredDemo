...
public class Demo {
    ...
    public void testJson(){
        when().get("http://192.168.31.172:8000/testdemo.json")
        .then()
    ...
    @Test
    public void testXml(){
        when().get("http://192.168.31.172:8000/testdemo.xml")
        .then()
            ...
            //.body("shopping.category.item.findAll { item -> def price = item.price.toFloat(); price >= 10 && price <= 20 }")
        ;
